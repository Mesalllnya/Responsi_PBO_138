...
import com.pbo.responsi.service.TrueDiscountStrategy;
...
public class Responsi {
    ...
    public static void main(String[] args) {
        ...
        DiscountStrategy discountStrategy = new TrueDiscountStrategy();
...
//              view.showCartItems(repository.findAll());
            ...
            view.showCartItems(repository.findAll(), subtotal, discountAmount, grandTotal, discountStrategy.getDiscountName());
        };
